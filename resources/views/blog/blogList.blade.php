...
@section('scripts')
    <script>
        const editBlogUrl = "{{ route('blog.edit', ['id' => ':id']) }}";
        ...
        function deleteBlog(id) {
            ...
            var deleteUrl = "{{ route('blog.delete', ['id' => ':id']) }}";
        ...
        function getAllBlogs() {
            ...
            $('#dataTable').DataTable({
                ...
                aoColumns: [{
                        ...
                        "mRender": function(d) {
                            let btn = '';
                            const editUrl = editBlogUrl.replace(':id', d.id);
                            btn +=
                                `<a href='${editUrl}'  class='btn btn-xs btn-success '><i class="fa fa-edit"></i></a>&nbsp;`;
                            btn +=
                                `<a href='javascript:void(0)' onclick='deleteBlog(${d.id})' class='btn btn-xs btn-danger deleteBlog'><i class="fa fa-trash"></i></a>`;
                            return btn;
                        }
                    },
                    {
                    ...
                    },
                    {
                        mData: null,
                        "mRender": function(d) {
                            return d.isActive === 1 ? '<span class="badge badge-success">Active</span>' :
