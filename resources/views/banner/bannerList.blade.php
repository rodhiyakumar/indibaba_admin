...
@section('scripts')
    <script>
        const editBannerUrl = "{{ route('banner.edit', ['id' => ':id']) }}";
        ...
        function deleteCategory(id) {
            ...
            var deleteUrl = "{{ route('category.delete', ['id' => ':id']) }}";
        ...
        function getAllBanners() {
            ...
            $('#dataTable').DataTable({
                ...
                aoColumns: [{
                        ...
                        "mRender": function(d) {
                            let btn = '';
                            const editUrl = editBannerUrl.replace(':id', d.id);
                            btn +=
                    ...
                    },
                    {
                        ...
                        "sWidth": "100px",
                        "mRender": function(d) {
                            return d.image ? `<img src="${d.image}" alt="Icon" width="80" height="80">` : 'N/A';
                        }
                    },
                    {
                        mData: null,
