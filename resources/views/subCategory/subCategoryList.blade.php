...
@section('scripts')
    <script>
        const editCategoryUrl = "{{ route('subCategory.edit', ['id' => ':id']) }}";
        ...
        function deleteSubCategory(id) {
            ...
            var deleteUrl = "{{ route('subCategory.delete', ['id' => ':id']) }}";
        ...
        function getAllSubCategories() {
            ...
            $('#dataTable').DataTable({
                ...
                aoColumns: [{
                        ...
                        "mRender": function(d) {
                            let btn = '';
                            const editUrl = editCategoryUrl.replace(':id', d.id);
                            btn +=
                                `<a href='${editUrl}'  class='btn btn-xs btn-success '><i class="fa fa-edit"></i></a>&nbsp;`;
                            btn +=
                                `<a href='javascript:void(0)' onclick='deleteSubCategory(${d.id})' class='btn btn-xs btn-danger deleteSubCategory'><i class="fa fa-trash"></i></a>`;
                            return btn;
                        }
                    },
                    {
                        mData: 'category.categoryName'
                    },
                    {
