...
@section('scripts')
    <script>
        const editCouponUrl = "{{ route('coupon.edit', ['id' => ':id']) }}";
        ...
        function deleteCoupon(id) {
            ...
            var deleteUrl = "{{ route('coupon.delete', ['id' => ':id']) }}";
        ...
        function getAllList() {
            ...
            $('#dataTable').DataTable({
                ...
                aoColumns: [{
                        ...
                        "mRender": function(d) {
                            let btn = '';
                            const editUrl = editCouponUrl.replace(':id', d.id);
                            btn +=
                                `<a href='${editUrl}'  class='btn btn-xs btn-success '><i class="fa fa-edit"></i></a>&nbsp;`;
                            btn +=
                                `<a href='javascript:void(0)' onclick='deleteCoupon(${d.id})' class='btn btn-xs btn-danger deleteCategory'><i class="fa fa-trash"></i></a>`;
                            return btn;
                        }
                    },
                    {
